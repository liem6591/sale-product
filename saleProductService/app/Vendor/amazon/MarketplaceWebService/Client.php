 ...
 */;
require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Interface.php');
require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/RequestType.php');
...
class MarketplaceWebService_Client implements MarketplaceWebService_Interface
{
  ...
  // Public API ------------------------------------------------------------//
  //require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model.php');  
  /**
   * Get Report
  ...
  public function getReportScheduleCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleCountRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportScheduleCountRequest.php');
      $request = new MarketplaceWebService_Model_GetReportScheduleCountRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportScheduleCountResponse.php');
  ...
  public function getReportRequestListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportRequestListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportRequestListByNextTokenResponse.php');
  ...
  public function updateReportAcknowledgements($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/UpdateReportAcknowledgementsRequest.php');
      $request = new MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/UpdateReportAcknowledgementsResponse.php');
  ...
  public function submitFeed($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_SubmitFeedRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/SubmitFeedRequest.php');
      $request = new MarketplaceWebService_Model_SubmitFeedRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/SubmitFeedResponse.php');
  ...
  public function getReportCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportCountRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportCountRequest.php');
      $request = new MarketplaceWebService_Model_GetReportCountRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportCountResponse.php');
  ...
  public function getFeedSubmissionListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionListByNextTokenResponse.php');
  ...
  public function cancelFeedSubmissions($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_CancelFeedSubmissionsRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/CancelFeedSubmissionsRequest.php');
      $request = new MarketplaceWebService_Model_CancelFeedSubmissionsRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/CancelFeedSubmissionsResponse.php');
  ...
  public function requestReport($request)
  {
    ...
    if (!$request instanceof MarketplaceWebService_Model_RequestReportRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/RequestReportRequest.php');
      $request = new MarketplaceWebService_Model_RequestReportRequest($request);
    }

    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/RequestReportResponse.php');

    $httpResponse = $this->invoke($this->convertRequestReport($request),null,null,"requestReport");
  ...
  public function getFeedSubmissionCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionCountRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionCountRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionCountRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionCountResponse.php');
  ...
  public function cancelReportRequests($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_CancelReportRequestsRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/CancelReportRequestsRequest.php');
      $request = new MarketplaceWebService_Model_CancelReportRequestsRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/CancelReportRequestsResponse.php');
  ...
  public function getReportList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportListRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportListRequest.php');
      $request = new MarketplaceWebService_Model_GetReportListRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportListResponse.php');
  ...
  public function getFeedSubmissionResult($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionResultRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionResultRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionResultRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionResultResponse.php');
  ...
  public function getFeedSubmissionList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionListRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionListRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionListRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetFeedSubmissionListResponse.php');
  ...
  public function getReportRequestList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequestListRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportRequestListRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequestListRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportRequestListResponse.php');
  ...
  public function getReportScheduleListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportScheduleListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportScheduleListByNextTokenResponse.php');
  ...
  public function getReportListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportListByNextTokenRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetReportListByNextTokenRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportListByNextTokenResponse.php');
  ...
  public function manageReportSchedule($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_ManageReportScheduleRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/ManageReportScheduleRequest.php');
      $request = new MarketplaceWebService_Model_ManageReportScheduleRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/ManageReportScheduleResponse.php');
  ...
  public function getReportRequestCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequestCountRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportRequestCountRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequestCountRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportRequestCountResponse.php');
  ...
  public function getReportScheduleList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleListRequest) {
      require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportScheduleListRequest.php');
      $request = new MarketplaceWebService_Model_GetReportScheduleListRequest($request);
    }
    require_once (VENDOR_PATH.'/amazon/MarketplaceWebService/Model/GetReportScheduleListResponse.php');
   ...
   * Invoke request and return response
   */
  private function invoke(array $converted, $dataHandle = null, $contentMd5 = null,$accountId = null,$reportType = null)
  {
    ...
    if (empty($this->config['ServiceURL'])) {
      ...
      do {
        try {
        	//if( $type == "requestReport" ){
         $response = $this->performRequestForGet($actionName, $converted, $dataHandle, $contentMd5,$accountId,$reportType );
        	//}else{
        	//	 $response = $this->performRequest($actionName, $converted, $dataHandle, $contentMd5);
        	//}
  ...
  private function performRequest($action, array $converted, $dataHandle = null, $contentMd5 = null) {
	...
	echo RequestType::getRequestType($action).'<br>' ;
    ...
    require_once(VENDOR_PATH.'/amazon/MarketplaceWebService/Model/ResponseHeaderMetadata.php');
