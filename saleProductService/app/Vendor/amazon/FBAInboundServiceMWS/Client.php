...
*/
require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Interface.php');
...
class FBAInboundServiceMWS_Client implements FBAInboundServiceMWS_Interface
{
    ...
    public function confirmTransportRequest($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_ConfirmTransportInputRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ConfirmTransportInputRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ConfirmTransportRequestResponse.php');
    ...
    public function createInboundShipment($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_CreateInboundShipmentRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/CreateInboundShipmentRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/CreateInboundShipmentResponse.php');
    ...
    public function createInboundShipmentPlan($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_CreateInboundShipmentPlanRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/CreateInboundShipmentPlanRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/CreateInboundShipmentPlanResponse.php');
    ...
    public function estimateTransportRequest($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_EstimateTransportInputRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/EstimateTransportInputRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/EstimateTransportRequestResponse.php');
    ...
    public function getBillOfLading($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_GetBillOfLadingRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetBillOfLadingRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetBillOfLadingResponse.php');
    ...
    public function getPackageLabels($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_GetPackageLabelsRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetPackageLabelsRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetPackageLabelsResponse.php');
    ...
    public function getServiceStatus($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_GetServiceStatusRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetServiceStatusRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetServiceStatusResponse.php');
    ...
    public function getTransportContent($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_GetTransportContentRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetTransportContentRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/GetTransportContentResponse.php');
    ...
    public function listInboundShipmentItems($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_ListInboundShipmentItemsRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentItemsRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentItemsResponse.php');
    ...
    public function listInboundShipmentItemsByNextToken($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_ListInboundShipmentItemsByNextTokenRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentItemsByNextTokenRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentItemsByNextTokenResponse.php');
    ...
    public function listInboundShipments($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_ListInboundShipmentsRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentsRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentsResponse.php');
    ...
    public function listInboundShipmentsByNextToken($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentsByNextTokenRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ListInboundShipmentsByNextTokenResponse.php');
    ...
    public function putTransportContent($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_PutTransportContentRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/PutTransportContentRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/PutTransportContentResponse.php');
    ...
    public function updateInboundShipment($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_UpdateInboundShipmentRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/UpdateInboundShipmentRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/UpdateInboundShipmentResponse.php');
    ...
    public function voidTransportRequest($request)
    {
        if (!($request instanceof FBAInboundServiceMWS_Model_VoidTransportInputRequest)) {
            require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/VoidTransportInputRequest.php');
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/VoidTransportRequestResponse.php');
   ...
   private function collapseWhitespace($s) {
    ...
    private function _reportAnyErrors($responseBody, $status, $responseHeaderMetadata, Exception $e =  null)
    {
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Exception.php');
    ...
    private function _httpPost(array $parameters)
    {
        ...
        require_once (VENDOR_PATH.'/amazon/FBAInboundServiceMWS/Model/ResponseHeaderMetadata.php');
        $responseHeaderMetadata = new FBAInboundServiceMWS_Model_ResponseHeaderMetadata(
