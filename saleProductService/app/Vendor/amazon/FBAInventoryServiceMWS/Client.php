 ...
 */
require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Interface.php');
...
class FBAInventoryServiceMWS_Client implements FBAInventoryServiceMWS_Interface
{
    ...
    $awsAccessKeyId, $awsSecretAccessKey, $config, $applicationName, $applicationVersion, $attributes = null)
    {
        ...
        $this->_serviceVersion = $this->_serviceVersion;
  ...
  private function quoteAttributeValue($s) {
    ...
    public function listInventorySupplyByNextToken($request)
    {
        if (!$request instanceof FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenRequest) {
            require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Model/ListInventorySupplyByNextTokenRequest.php');
            $request = new FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenRequest($request);
        }
        require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Model/ListInventorySupplyByNextTokenResponse.php');
    ...
    public function listInventorySupply($request)
    {
        if (!$request instanceof FBAInventoryServiceMWS_Model_ListInventorySupplyRequest) {
            require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Model/ListInventorySupplyRequest.php');
            $request = new FBAInventoryServiceMWS_Model_ListInventorySupplyRequest($request);
        }
        require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Model/ListInventorySupplyResponse.php');
    ...
    public function getServiceStatus($request)
    {
        if (!$request instanceof FBAInventoryServiceMWS_Model_GetServiceStatusRequest) {
            require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Model/GetServiceStatusRequest.php');
            $request = new FBAInventoryServiceMWS_Model_GetServiceStatusRequest($request);
        }
        require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Model/GetServiceStatusResponse.php');
            ...
            do {
                try {
                        ...
                        switch ($httpStatus)
                        {
                            ...
                            case 500:
                            case 503:
                                require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Model/ErrorResponse.php');
                ...
                /* Rethrow on deserializer error */
                    ...
                    require_once (VENDOR_PATH.'/amazon/FBAInventoryServiceMWS/Exception.php');
