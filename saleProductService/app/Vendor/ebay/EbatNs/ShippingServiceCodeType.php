 ...
 * thecompleteness of ShippingServiceCodeType. Instead, applications should 
 * callGeteBayDetails, with a DetailName value of ShippingServiceDetails, to return 
 * thecomplete list of shipping services. To check for the shipping services 
 * availablefor a specific site, specify the site ID in the header. It is possible 
 * that some ofthe returned shipping services can no longer be used in the AddItem 
 * family ofcalls. To distinguish between the valid and invalid shipping services, 
 * look for theValidForSellingFlow flag in the ShippingServiceDetails node. If this 
 * flag is notreturned for a specific shipping service, that shipping service can 
 * no longer beused in the AddItem family of calls. 
 *
