...
//
// 
// auto-generated 22.03.2013 08:43 
// Ebay-Schema Version 815
//
/**
...
class EbatNs_ServiceProxy extends EbatNs_Client
{
	...
	function AddItemBody($request,$body)
	{
		$request->setVersion(EBAY_WSDL_VERSION);
		return $this->callBody('AddItem', $request,$body);
	}
	/**
