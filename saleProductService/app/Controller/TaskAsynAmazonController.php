 ...
 AND srpr.SKU = sc_amazon_account_product.SKU
    ...
    */
	...
	public function createInboundShipment( $accountId,$shipmentId ){
		...
		$result = $amazon->createInboundShipment($accountId,$shipmentId)  ;
		return $result ;
	...
	public function updateInboundShipment( $accountId,$shipmentId ){
		...
		$result = $amazon->updateInboundShipment($accountId,$shipmentId)  ;
		return $result ;
	...
	public function getPackageLabels( $accountId,$shipmentId, $pageType, $NumberOfPackages ){
		...
		$result = $amazon->getPackageLabels($accountId, $shipmentId, $pageType, $NumberOfPackages) ;
		return $result ;
	}
	...
	public function putTransportContent( $accountId,$shipmentId ){
		...
		$result = $amazon->putTransportContent($accountId,$shipmentId)  ;
		return $result ;
